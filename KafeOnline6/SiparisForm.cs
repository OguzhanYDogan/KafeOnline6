...
namespace KafeOnline6
{
    public partial class SiparisForm : Form
    {
        ...
        {
            dgvDetaylar.DataSource = _siparis.SiparisDetaylar.ToList(); // Değişiklik olduğunda anlaması için list
            Guncelle();
        }
        ...
        private void dgvDetaylar_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                // seçili satıra bağlı nesne. Sadece 1 tane seçmesine izin verdiğimiz için seçilenlerin ilkini sil diyebiliyoruz.
