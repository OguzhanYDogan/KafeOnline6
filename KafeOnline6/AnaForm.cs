...
namespace KafeOnline6
{
    public partial class AnaForm : Form
    {
        ...
        private void lvwMasalar_DoubleClick(object sender, EventArgs e)
        {
            ...
            // MasaNo'su tıklanan öğenin nosuna eşit ilk siparişi getir. Bulamazsa default olarak null getirir.
            ...
            // Yeni bir sipariş penceresi aç.
            SiparisForm siparisForm = new SiparisForm(db, siparis);
            siparisForm.ShowDialog();

            if (siparis.Durum != SiparisDurum.Aktif) // Masa rengini tekrar gri yapmak için.
            {
                lvi.ImageKey = "bos";
            }
        }
